var versionNumber = { version: 25 } // to reset file cache forefully on prod. Updated with shell script.
...
$("form .submit").on('click', $(this), function() {
    ...
    var dataContext = function() { return $(this).closest('form').removeAttr('id').removeAttr('_lpchecked'); } // set data context for calling form reset function
