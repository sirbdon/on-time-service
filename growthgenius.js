...
<div class="row">\
  <div class="col-md-12">\
    <h2><strong>On Time</br>Watch & Jewellery Service</strong></h2>\
  </div>\
</div>\
<div class="row">\
  <div class="col-md-12">\
...
<div class="row" style="text-align:left">\
  <div class="col-md-4 pull-left hidden-xs hidden-sm">\
    <img id="homeDetailsWatch" src="http://i.imgur.com/7Er7Fhv.png" style="height:310px">\
  </div>\
  <div class="col-md-8 pull-right">\
    <p class="homeDetails">Complete watch servicing, from full rebuilds and technical revisions all the way down to battery replacement and ultrasonic cleaning.</p>\
  </div>\
  <div class="col-md-8 pull-right">\
    <p class="homeDetails">Anything you can imagine we can do with jewellery. From completely custom build rings, converting heirlooms into a modern brooch all the way to chain repairs, ring sizing, and chain soldering.<p>\
  </div>\
  <div class="col-md-8 pull-right">\
    <p class="homeDetails">A large variety of accessories and other services are also available. We\'re confident we can meet any of your watch and jewellery desires. Please reach out using the form at the top or at the email below.</p>\
  </div>\
</div>\
</div>'
