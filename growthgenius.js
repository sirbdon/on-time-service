var versionNumber = { version: 15 } // to reset file cache forefully on prod. Updated with shell script.
...
// ======= HELPER FUNCTIONS: =======
  ...
  var contactReset = function() {
    ...
    $(this).get(0).reset() // reset this form. Need .get(0) to return html element (instead of $jQuery object)
