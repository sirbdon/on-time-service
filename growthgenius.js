var versionNumber = { version: 14 } // to reset file cache forefully on prod. Updated with shell script.
...
// ======= HELPER FUNCTIONS: =======
  ...
  var contactReset = function() {
    ...
    $(this).reset() // reset this form. Need [0] so data is sent to 'reset' in proper format.
