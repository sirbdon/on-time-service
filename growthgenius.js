versionNumber = { version: 38 } // to reset file cache forefully on prod. Updated with shell script.
...
// ======= BASIC HTML FOR ADDITIONS / REPLACEMENTS =======
  ...
  $('div#canvas div.sqs-layout.sqs-grid-12 div.row.sqs-row div.col.sqs-col-12').eq(1).prepend(locationWrap).append('<p class="text-align-center">email placeholder</p>')
