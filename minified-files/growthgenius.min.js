...
$(document).ready(function(){function e(){$(document).width()<=1033&&$('a[href="/products/"]').html("Other"),$(document).width()>1033&&$('a[href="/products/"]').html("Other Products & Services"),$(document).width()<=992&&($("#homeDetailsWatch").hide(),$(".homeDetails").css("text-align","center")),$(document).width()>992&&($("#homeDetailsWatch").show(),$(".homeDetails").css("text-align","left")),n()&&($("div.site-city-state").replaceWith(u),$("div.site-phone").replaceWith(E),$("#mobileMenuLink").addClass("phonex-menu").prepend(phoneMenuImages),$("#mobileMenuLink > a").remove(),$("#mobileMenuLink").prepend($('<a style="display:none">'))),n()||$("div.site-phone").replaceWith(t)}var t=$("div.site-phone"),n=function(){return"block"===$("div.or-call").css("display")&&"block"===$("div.site-phone").css("display")},o=function(){var e=Boolean("1"===$("div.or-call").css("opacity")),t=Boolean("1"===$("div.site-phone").css("opacity")),o=n()
