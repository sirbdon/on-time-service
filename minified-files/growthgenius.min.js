versionNumber={version:75},$(document).ready(function(){function e(){$(".buyButton").remove(),$(this).parent().append(E)}function t(){$(this).parent().find(".buyButton:hover").length||$(".buyButton").remove()}var n=function(){return"block"===$("div.or-call").css("display")&&"block"===$("div.site-phone").css("display")},o=function(){var e=Boolean("1"===$("div.or-call").css("opacity")),t=Boolean("1"===$("div.site-phone").css("opacity")),o=n()
...
var b="",k="",_="",w="",x="",q='<span class="thank-you site-address phonex" style="display:none; color:rgb(0,0,0);opacity:1;">Thanks! We\'ll be in touch soon.</span>',B={message:b,contact:k,page:r,time:d,_cc:_,_subject:w,_gotcha:x}
...
$("a.project div.content-fill").hover(e,t),$(".buyButton").hover(function(){},t),$("a.buyButton").click(function(){console.log("clicked"),$("#tawkchat-minified-wrapper").click(),$("#tawkchat-minified-container").click()}),$("head").after("<!--  \n /$$     /$$              /$$   /$$ /$$           /$$      \n|  $$   /$$/             | $$$ | $$|__/          | $$      \n \\  $$ /$$//$$$$$$       | $$$$| $$ /$$  /$$$$$$$| $$   /$$\n  \\  $$$$//$$__  $$      | $$ $$ $$| $$ /$$_____/| $$  /$$/\n   \\  $$/| $$  \\ $$      | $$  $$$$| $$| $$      | $$$$$$/ \n    | $$ | $$  | $$      | $$\\  $$$| $$| $$      | $$_  $$ \n    | $$ |  $$$$$$/      | $$ \\  $$| $$|  $$$$$$$| $$ \\  $$\n    |__/  \\______/       |__/  \\__/|__/ \\_______/|__/  __/\n                                                           \n                                                           \n                                                           -->")})
