...
$(document).ready(function(){function e(){$(document).width()<=1033&&$('a[href="/products/"]').html("Other"),$(document).width()>1033&&$('a[href="/products/"]').html("Other Products & Services"),$(document).width()<=992&&($("#homeDetailsWatch").hide(),$(".homeDetails").css("text-align","center")),$(document).width()>992&&($("#homeDetailsWatch").show(),$(".homeDetails").css("text-align","left")),n()&&($("div.site-city-state").replaceWith(u),$("div.site-phone").replaceWith(E),$("#mobileMenuLink").addClass("phonex-menu").prepend(phoneMenuImages),$("#mobileMenuLink > a").html("More")),n()||$("div.site-phone").replaceWith(t)}var t=$("div.site-phone"),n=function(){return"block"===$("div.or-call").css("display")&&"block"===$("div.site-phone").css("display")},o=function(){var e=Boolean("1"===$("div.or-call").css("opacity")),t=Boolean("1"===$("div.site-phone").css("opacity")),o=n()
...
return o},c=function(){for(i=0;i<document.forms.length;i++)document.forms[i].reset()
console.log("contact reset $this:"),console.log($(this)),$(".thank-you").fadeOut("fast"),$(".thank-you").remove(),$(this).find(".none1, .none0").hide(),$(this).hasClass("form-style-lower")?null:$(this).find('input[name="message"]').eq(0).prop("style").width="20%",$(this).find('input[name="message"]').prop("placeholder","Type here..."),$(this).find("input").prop("required",!1),$(this).fadeIn("fast"),$(this).find(".some0").fadeIn("fast"),o(),console.log("form RESET")},l=function(){return moment().tz("America/Los_Angeles").format("MMMM Do YYYY, h:mm:ss a (zz)")},d=""
$("head").append('<meta name="format-detection" content="telephone=no">')
var m='<div style="position:absolute;height:20%;width:30%;background-color:rgba(255, 0, 0, 0);display:hidden;left:50%;margin-left:-15%" id="service-outer"><div style="position:relative;height:100%;width:100%;background-color:rgba(255, 0, 0, 0);cursor:pointer;z-index:50;margin-top: 79%;" id="service-inner"></div></div>',p='<div style="position:absolute;height:20%;width:30%;background-color:rgba(255, 0, 0, 0);display:hidden;left:20%;margin-left:-15%" id="locations-outer"><div style="position:relative;height:100%;width:100%;background-color:rgba(255, 0, 0, 0);cursor:pointer;z-index:50;margin-top: 79%;" id="locations-inner"></div></div>'
$("div.image-wrapper").prepend(m,p),$("#service-inner").click(function(){window.location="http://ontimeserviceco.com/watch-services/"}),$("#locations-inner").click(function(){window.location="http://ontimeserviceco.com/locations/"})
...
var b="",y="",w="",k="",_="",x='<span class="thank-you site-address phonex" style="display:none; color:rgb(0,0,0);opacity:1;">Thanks! We\'ll be in touch soon.</span>',q={message:b,contact:y,page:r,time:d,_cc:w,_subject:k,_gotcha:_}
