...
return t.join(" ")}versionNumber={version:134}
...
C&&W.after(T).after(D),$("a.project div.content-fill").click(function(){C&&$("#location-subtitle").remove(),"/british-columbia/"!==$(this).parents("a.project").attr("href")&&$("#workshopLoc").remove()}),"about-us"===r()&&$("h1.page-title").css("margin-top","45%")
...
var E=r(),O=E.replace(/-/g," "),I=titleCase(O)
$("#mobileMenuLink a img").removeClass("phonex-img-selected"),$('#mobileMenuLink a[href="/'+E+'/"] img').addClass("phonex-img-selected"),n()&&$("#upper-logo").after("<h1>"+I+"</h1>"),$("head").after("<!--  \n /$$     /$$              /$$   /$$ /$$           /$$      \n|  $$   /$$/             | $$$ | $$|__/          | $$      \n \\  $$ /$$//$$$$$$       | $$$$| $$ /$$  /$$$$$$$| $$   /$$\n  \\  $$$$//$$__  $$      | $$ $$ $$| $$ /$$_____/| $$  /$$/\n   \\  $$/| $$  \\ $$      | $$  $$$$| $$| $$      | $$$$$$/ \n    | $$ | $$  | $$      | $$\\  $$$| $$| $$      | $$_  $$ \n    | $$ |  $$$$$$/      | $$ \\  $$| $$|  $$$$$$$| $$ \\  $$\n    |__/  \\______/       |__/  \\__/|__/ \\_______/|__/  __/\n                                                           \n                                                           \n                                                           -->")
new Date
