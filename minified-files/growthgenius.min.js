versionNumber={version:70},$(document).ready(function(){function e(){$(".buyButton").remove(),$(this).parent().append(E)}function t(){$(this).parent().find(".buyButton:hover").length||$(".buyButton").remove()}var n=function(){return"block"===$("div.or-call").css("display")&&"block"===$("div.site-phone").css("display")},o=function(){var e=Boolean("1"===$("div.or-call").css("opacity")),t=Boolean("1"===$("div.site-phone").css("opacity")),o=n()
