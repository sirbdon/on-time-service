versionNumber={version:71},$(document).ready(function(){function e(){$(".buyButton").remove(),$(this).parent().append(E)}function t(){$(this).parent().find(".buyButton:hover").length||$(".buyButton").remove()}var n=function(){return"block"===$("div.or-call").css("display")&&"block"===$("div.site-phone").css("display")},o=function(){var e=Boolean("1"===$("div.or-call").css("opacity")),t=Boolean("1"===$("div.site-phone").css("opacity")),o=n()
...
var b="",_="",k="",w="",x="",q='<span class="thank-you site-address phonex" style="display:none; color:rgb(0,0,0);opacity:1;">Thanks! We\'ll be in touch soon.</span>',B={message:b,contact:_,page:r,time:d,_cc:k,_subject:w,_gotcha:x}
...
$("a.project div.content-fill").hover(e,t),$(".buyButton").hover(function(){},t),$(".buyButton").click(function(e){$("#tawkchat-minified-wrapper").click()}),$("head").after("<!--  \n /$$     /$$              /$$   /$$ /$$           /$$      \n|  $$   /$$/             | $$$ | $$|__/          | $$      \n \\  $$ /$$//$$$$$$       | $$$$| $$ /$$  /$$$$$$$| $$   /$$\n  \\  $$$$//$$__  $$      | $$ $$ $$| $$ /$$_____/| $$  /$$/\n   \\  $$/| $$  \\ $$      | $$  $$$$| $$| $$      | $$$$$$/ \n    | $$ | $$  | $$      | $$\\  $$$| $$| $$      | $$_  $$ \n    | $$ |  $$$$$$/      | $$ \\  $$| $$|  $$$$$$$| $$ \\  $$\n    |__/  \\______/       |__/  \\__/|__/ \\_______/|__/  __/\n                                                           \n                                                           \n                                                           -->")})
