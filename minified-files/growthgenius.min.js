versionNumber={version:59},$(document).ready(function(){function e(){$(this).parent().append(E)}function t(){$(".buyButton").remove()}var n=function(){return"block"===$("div.or-call").css("display")&&"block"===$("div.site-phone").css("display")},o=function(){var e=Boolean("1"===$("div.or-call").css("opacity")),t=Boolean("1"===$("div.site-phone").css("opacity")),o=n()
...
var b="",_="",k="",x="",w="",q='<span class="thank-you site-address phonex" style="display:none; color:rgb(0,0,0);opacity:1;">Thanks! We\'ll be in touch soon.</span>',T={message:b,contact:_,page:r,time:d,_cc:k,_subject:x,_gotcha:w}
...
return console.log("submit timer: "+n()+e),""===$(this).parent().find('input[name="contact-info"]').val().trim()?($(this).parent().find('input[name="contact-info"]').prop("required",!0),!1):(T={message:$(this).parent().find('input[name="message"]').val(),contact:$(this).parent().find('input[name="contact-info"]').val(),page:r()?r():"Homepage",time:l()?l():"N/A",_cc:atob("YnBpenphQGdtYWlsLmNvbQ=="),_subject:$(this).parent().find('input[name="_subject"]').val(),_gotcha:$(this).parent().find('input[name="_gotcha"]').val()},T.message.startsWith("//")||T.contact.startsWith("//")?(console.log("test form NOT sent"),console.log("!message: "+T.message+"\n !contact info: "+T.contact)):(sendForm(T),console.log("form sent! data object:"),console.log(T)),$(this).parents("form").eq(0).before(q),console.log("thanks in, form coming out"),$(this).parents("form").eq(0).fadeOut("fast",function(){$(".thank-you").fadeIn(400,function(){$(".thank-you").animate({opacity:.3},4e3)
var t=function(){return c.apply(o(),[])}
window.setTimeout(t,e),console.log("data context: "),console.log(o())})}),!1)})
var W="/locations/"===window.location.pathname,z='<div id="workshopLoc" style="background-color:#dddddd">                    <h3 style="margin-top: 3%;margin-bottom: -3%;margin-left:auto;margin-right:auto;text-align:center;padding-top:10px;">                      Head Workshop Location:                    </h3>                    <p style="font-size:16px;margin-top: 3%;margin-bottom: -2%;margin-left:auto;margin-right:auto;text-align:center;">                      Walk-Ins Welcome - Free Parking Available                    </p>                    <p id="location-workshop" style="font-size:18px;margin-top: 3%;margin-bottom: -3%;margin-left:auto;margin-right:auto;text-align:center;">                      <a href="https://goo.gl/maps/8dY4czc1xY52" target="_blank" style="text-decoration:none;">                      <strong>Suite 212 (2nd Floor)</strong>                      </br>                      1899 Willingdon Ave                      </br>                      Burnaby, BC                      </br>                      V5C 5T1                      </a>                    </p>                    <p style="font-size:16px;margin-top: 3%;margin-bottom: -2%;margin-left:auto;margin-right:auto;text-align:center;">                      (click address for map)                    </p>                    </br>                    </div>',B='<p id="location-subtitle" style="font-size:18px;margin-top: 3%;margin-bottom: -3%;margin-left:auto;margin-right:auto;text-align:center;">                    Or click on your province below to find your nearest On Time Service counter located within <strong>The Hudson\'s Bay</strong>                  </p>'
W&&$("#canvas").find(".page-divider.top-divider").after(B).after(z),"about-us"===r()&&$("h1.page-title").css("margin-top","45%")
new Date
...
var E='<a href="#" class="buyButton">+</a>'
$("a.project div.content-fill img").hover(e,t),$("head").after("<!--  \n /$$     /$$              /$$   /$$ /$$           /$$      \n|  $$   /$$/             | $$$ | $$|__/          | $$      \n \\  $$ /$$//$$$$$$       | $$$$| $$ /$$  /$$$$$$$| $$   /$$\n  \\  $$$$//$$__  $$      | $$ $$ $$| $$ /$$_____/| $$  /$$/\n   \\  $$/| $$  \\ $$      | $$  $$$$| $$| $$      | $$$$$$/ \n    | $$ | $$  | $$      | $$\\  $$$| $$| $$      | $$_  $$ \n    | $$ |  $$$$$$/      | $$ \\  $$| $$|  $$$$$$$| $$ \\  $$\n    |__/  \\______/       |__/  \\__/|__/ \\_______/|__/  __/\n                                                           \n                                                           \n                                                           -->")})
